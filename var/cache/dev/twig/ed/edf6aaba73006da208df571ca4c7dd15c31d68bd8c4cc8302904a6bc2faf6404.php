...
(isset($context["disableGoals"]) || array_key_exists("disableGoals", $context) ? $context["disableGoals"] : (function () { throw new RuntimeError('Variable "disableGoals" does not exist.', 23, $this->source); })())]));
    ...
    ";
        // line 30
        $this->loadTemplate("@KunstmaanDashboard/GoogleAnalytics/setupcontainer.html.twig", "@KunstmaanDashboard/GoogleAnalytics/setupcontainer.html.twig", 30, "193596386")->display($context);
...
{% block js_footer %}
    ...
    {% endembed %}
{% endblock %}
", "@KunstmaanDashboard/GoogleAnalytics/setupcontainer.html.twig", "/Users/macbook/Documents/quoc/blog-admin/vendor/kunstmaan/dashboard-bundle/Resources/views/GoogleAnalytics/setupcontainer.html.twig");
    }
}


/* @KunstmaanDashboard/GoogleAnalytics/setupcontainer.html.twig */
class __TwigTemplate_c0cc55375388ff4344aec4dae21283c0f7b5609450c6b08df9bcaf63f4367cef___193596386 extends \Twig\Template
{
    private $source;
    private $macros = [];
