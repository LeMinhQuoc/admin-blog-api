...
{% if not hide_children_from_sitemap(entry) %}
    ...
    {% endfor %}
{% endif %}
", "@KunstmaanSitemap/Sitemap/entry.xml.twig", "/Users/macbook/Documents/quoc/admin-blog-api-/vendor/kunstmaan/sitemap-bundle/Resources/views/Sitemap/entry.xml.twig");
    }
}
