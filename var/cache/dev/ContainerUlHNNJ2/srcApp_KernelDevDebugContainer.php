...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder69bd6 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer3207c = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiescc2f1 = [
        
    ];

    public function getConnection()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getConnection', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getMetadataFactory', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getExpressionBuilder', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'beginTransaction', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getCache', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getCache();
    }

    public function transactional($func)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'transactional', array('func' => $func), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->transactional($func);
    }

    public function commit()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'commit', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->commit();
    }

    public function rollback()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'rollback', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getClassMetadata', array('className' => $className), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'createQuery', array('dql' => $dql), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'createNamedQuery', array('name' => $name), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'createQueryBuilder', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'flush', array('entity' => $entity), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'clear', array('entityName' => $entityName), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->clear($entityName);
    }

    public function close()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'close', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->close();
    }

    public function persist($entity)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'persist', array('entity' => $entity), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'remove', array('entity' => $entity), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'refresh', array('entity' => $entity), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'detach', array('entity' => $entity), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'merge', array('entity' => $entity), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getRepository', array('entityName' => $entityName), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'contains', array('entity' => $entity), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getEventManager', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getConfiguration', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'isOpen', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getUnitOfWork', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getProxyFactory', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'initializeObject', array('obj' => $obj), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'getFilters', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'isFiltersStateClean', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'hasFilters', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return $this->valueHolder69bd6->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer3207c = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder69bd6) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder69bd6 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder69bd6->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, '__get', ['name' => $name], $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        if (isset(self::$publicPropertiescc2f1[$name])) {
            return $this->valueHolder69bd6->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder69bd6;
    ...
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;
    ...
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, '__isset', array('name' => $name), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;
    ...
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, '__unset', array('name' => $name), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;
    ...
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, '__clone', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        $this->valueHolder69bd6 = clone $this->valueHolder69bd6;
    }

    public function __sleep()
    {
        $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, '__sleep', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;

        return array('valueHolder69bd6');
    }
    ...
    {
        $this->initializer3207c = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer3207c;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer3207c && ($this->initializer3207c->__invoke($valueHolder69bd6, $this, 'initializeProxy', array(), $this->initializer3207c) || 1) && $this->valueHolder69bd6 = $valueHolder69bd6;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder69bd6;
    }

    public function getWrappedValueHolderValue() : ?object
    {
        return $this->valueHolder69bd6;
    }
